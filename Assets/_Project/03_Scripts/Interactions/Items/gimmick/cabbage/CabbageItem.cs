...
/// <summary>
/// 통 양배추 (비틀비틀 양배추).
/// 칼로 자르면 CutGuidelineConfig.resultPrefabs에 지정된 결과물로 분리됩니다.
///
/// [기믹]
...
/// </summary>
public class CabbageItem : PickableItem, ICookable, ICuttable
{
    ...
    /// <summary>
    /// 자르는 순간 ManualBookItem을 들지 않은 플레이어에게 이동 반전 디버프 적용.
    /// </summary>
    ...
    {
        if (target is CutCabbageItem cut)
        {
