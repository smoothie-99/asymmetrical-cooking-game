...
/// <summary>
/// 깍뚝썰기된 조개살.
/// ClamMeatItem 을 깍뚝썰기 가이드라인으로 자르면 스폰됩니다.
/// 시각적으로 조그마한 네모 군집으로 표현됩니다.
/// </summary>
public class DicedClamMeatItem : PickableItem, ICookable
{
    [Header("Visual")]
    ...
    private void UpdateItemName()
    {
        ...
        itemName = $"깍뚝 조개살{flavorStr} [{CurrentCookState.ToKoreanString()}]";
